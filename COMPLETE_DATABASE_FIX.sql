...
-- This will create all missing tables for the application
...
-- Step 3: Create load_entries table if it doesn't exist
...
-- Step 4: Create salaries table if it doesn't exist
